...
## 定义
User Prompt 是 大模型 / LLM 中的一项核心能力或机制，用于组织和发挥 生成式模型的输入、输出、能力控制与成本权衡。

## 核心问题
核心问题是：User Prompt 能解决什么问题、边界在哪里、应该和哪些机制组合使用。

## 关键关系
- 所属结构：[[知识卡/原理层/大模型_LLM/0_大模型_LLM|大模型 / LLM]]
- 同目录知识：[[知识卡/原理层/大模型_LLM/Developer Prompt|Developer Prompt]]、[[知识卡/原理层/大模型_LLM/Temperature|Temperature]]
