...
## 定义
nDCG 是 知识检索与 RAG 中用于判断效果、质量或系统状态的关键指标，关注的是 知识召回、排序、证据注入与知识更新。

## 核心问题
核心问题是：nDCG 到底在衡量什么、阈值如何设定、异常时说明哪一环出了问题。

## 关键关系
- 所属结构：[[知识卡/应用工程层/知识检索与 RAG/0_知识检索与 RAG|知识检索与 RAG]]
- 同目录知识：[[知识卡/应用工程层/知识检索与 RAG/MRR|MRR]]、[[知识卡/应用工程层/知识检索与 RAG/Context Precision|Context Precision]]
