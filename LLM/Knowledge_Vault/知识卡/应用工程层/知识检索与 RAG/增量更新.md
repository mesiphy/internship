...
## 定义
增量更新 是 知识检索与 RAG 中常见的工程处理策略，用来稳定 知识召回、排序、证据注入与知识更新 对应的链路表现。

## 核心问题
核心问题是：什么时候需要用 增量更新、会带来什么代价、该如何与上下游策略配合。

## 关键关系
- 所属结构：[[知识卡/应用工程层/知识检索与 RAG/0_知识检索与 RAG|知识检索与 RAG]]
- 同目录知识：[[知识卡/应用工程层/知识检索与 RAG/知识更新|知识更新]]、[[知识卡/应用工程层/知识检索与 RAG/权限感知检索|权限感知检索]]
