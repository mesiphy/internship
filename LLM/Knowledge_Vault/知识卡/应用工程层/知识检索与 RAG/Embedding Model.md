...
## 定义
Embedding Model 是 知识检索与 RAG 中的一项核心能力或机制，用于组织和发挥 知识召回、排序、证据注入与知识更新。

## 核心问题
核心问题是：Embedding Model 能解决什么问题、边界在哪里、应该和哪些机制组合使用。

## 关键关系
- 所属结构：[[知识卡/应用工程层/知识检索与 RAG/0_知识检索与 RAG|知识检索与 RAG]]
- 同目录知识：[[知识卡/应用工程层/知识检索与 RAG/Embedding|Embedding]]、[[知识卡/应用工程层/知识检索与 RAG/向量化|向量化]]
