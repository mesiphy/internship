...
## 定义
权限感知检索 是 知识检索与 RAG 中的风险与约束节点，用来控制 知识召回、排序、证据注入与知识更新 相关的错误、越权或不合规问题。

## 核心问题
核心问题是：权限感知检索 的风险从哪里来、会影响哪一层、应该如何预防、监控和兜底。

## 关键关系
- 所属结构：[[知识卡/应用工程层/知识检索与 RAG/0_知识检索与 RAG|知识检索与 RAG]]
- 同目录知识：[[知识卡/应用工程层/知识检索与 RAG/增量更新|增量更新]]、[[知识卡/应用工程层/知识检索与 RAG/引用|引用]]
