...
## 定义
Embedding 是 知识检索与 RAG 中的一项核心能力或机制，用于组织和发挥 知识召回、排序、证据注入与知识更新。
...
- 同目录知识：[[知识卡/应用工程层/知识检索与 RAG/结构化切片|结构化切片]]、[[知识卡/应用工程层/知识检索与 RAG/Embedding Model|Embedding Model]]
...
- 同名延伸：[[知识卡/原理层/深度学习与Transformer/embedding|深度学习与Transformer]]
...
- [[知识卡/原理层/深度学习与Transformer/embedding|深度学习与Transformer]]
