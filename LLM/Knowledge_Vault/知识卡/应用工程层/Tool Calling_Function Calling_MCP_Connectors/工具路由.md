...
## 定义
工具路由 是 Tool Calling / Function Calling / MCP / Connectors 中常见的工程处理策略，用来稳定 工具接入、调用闭环、权限与执行控制 对应的链路表现。

## 核心问题
核心问题是：什么时候需要用 工具路由、会带来什么代价、该如何与上下游策略配合。
...
- 同目录知识：[[知识卡/应用工程层/Tool Calling_Function Calling_MCP_Connectors/工具选择|工具选择]]、[[知识卡/应用工程层/Tool Calling_Function Calling_MCP_Connectors/工具编排|工具编排]]
