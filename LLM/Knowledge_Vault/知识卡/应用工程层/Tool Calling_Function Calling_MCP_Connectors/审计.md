...
## 定义
审计 是 Tool Calling / Function Calling / MCP / Connectors 中的风险与约束节点，用来控制 工具接入、调用闭环、权限与执行控制 相关的错误、越权或不合规问题。

## 核心问题
核心问题是：审计 的风险从哪里来、会影响哪一层、应该如何预防、监控和兜底。
...
- 同目录知识：[[知识卡/应用工程层/Tool Calling_Function Calling_MCP_Connectors/权限隔离|权限隔离]]、[[知识卡/应用工程层/Tool Calling_Function Calling_MCP_Connectors/SSO|SSO]]
