...
## 定义
问题归因 是 Evals / Guardrails / Observability 中的观测与定位抓手，用于连接运行现象、版本变化和问题归因。

## 核心问题
核心问题是：如何借助 问题归因 观察系统运行状态，并把现象准确归因到模型、检索、工具或流程。
...
- 同目录知识：[[知识卡/应用工程层/Evals_Guardrails_Observability/Observability/Workflow Version|Workflow Version]]、[[知识卡/应用工程层/Evals_Guardrails_Observability/Observability/灰度发布|灰度发布]]
